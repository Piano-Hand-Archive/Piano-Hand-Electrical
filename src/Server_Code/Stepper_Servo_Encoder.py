...
async def main():
    ...
    async with BleakClient(device) as client:
        ...
        print("Enter commands in format: (C4,G4,2) or type 'exit' to quit.\n")
        ...
        while True:
            ...
            if not (cmd.startswith("(") and cmd.endswith(")") and len(cmd.split(",")) == 3):
                print("Invalid format. Use (CurrentNote,TargetNote,FingerNum) e.g., (C4,G4,2)")
                continue
